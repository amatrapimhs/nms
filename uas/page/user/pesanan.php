...
<?php
    ...
    try {
      ...
      $insert = $conn->prepare("INSERT INTO tbl_pesanan (id_user,id_barang,warna,qty,kurir,date_in,total) SELECT id_user,id_barang,warna,qty,kurir,date_in,total FROM tbl_keranjang WHERE id_user=:id");
  ...
  <table class="article">
    ...
    <tr>
      <td></td>
      <td>
        Terima kasih telah membeli Mobil di website kami <br>
